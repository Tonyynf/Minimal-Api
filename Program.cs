...
#region Veiculos
ErrosDeValidacao validaDTO(VeiculosDTO veiculoDTO)
{
var validacao = new ErrosDeValidacao
{
    Mensagens = new List<string>()
...
app.MapPost("/veiculos", ([FromBody] VeiculosDTO veiculoDTO, IVeiculoServico veiculoServico) =>
{
...
app.MapPut("/veiculos/{id}", ([FromRoute]int id, VeiculosDTO veiculoDTO,IVeiculoServico veiculoServico) =>
{   
    var veiculo = veiculoServico.BuscaPorId(id);
    if(veiculo == null) return Results.NotFound();
